...
export default function AccountTabButton({ isActive, onClick }) {
  return (
    <button
      onClick={onClick}
    ...
    >
      <Settings className={`w-5 h-5 shrink-0 transition-transform duration-300 group-hover:scale-105 ${isActive ? 'text-white' : 'text-amber-600'}`} />
