          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-black text-xl text-white tracking-tight">
                Interactive Real-Time Risk Simulator
              </h3>
              <p className="text-xs text-slate-300 font-medium">
                Drag clinical parameters below to watch continuous risk
          ...
          <div className="lg:col-span-7 space-y-4 glass-panel rounded-2xl p-5 max-h-[420px] overflow-y-auto pr-3 border border-slate-800 bg-slate-900/70">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                min="60"
                max="250"
                value={simParams?.glucose ?? 100}
                onChange={(e) => {
                  soundFX.play("slider");
                  setSimParams((prev) => ({
                    ...prev,
                    glucose: parseInt(e.target.value) || 100,
                  }));
                }}
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                min="85"
                max="200"
                value={simParams?.bpSystolic ?? 120}
                onChange={(e) => {
                  soundFX.play("slider");
                  setSimParams((prev) => ({
                    ...prev,
                    bpSystolic: parseInt(e.target.value) || 120,
                  }));
                }}
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                max="45"
                step="0.5"
                value={simParams?.bmi ?? 24}
                onChange={(e) => {
                  soundFX.play("slider");
                  setSimParams((prev) => ({
                    ...prev,
                    bmi: parseFloat(e.target.value) || 24,
                  }));
                }}
                className="w-full h-2 rounded-lg appearance-none cursor-pointer accent-amber-400"
              />
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs font-bold">
                ...
                <span className="text-purple-400 font-mono font-black">
                  {simParams?.cholesterol ?? 180} mg/dL
                </span>
              </div>
              <input
                type="range"
                min="110"
                max="360"
                value={simParams?.cholesterol ?? 180}
                onChange={(e) => {
                  soundFX.play("slider");
                  setSimParams((prev) => ({
                    ...prev,
                    cholesterol: parseInt(e.target.value) || 180,
                  }));
                }}
                className="w-full h-2 rounded-lg appearance-none cursor-pointer accent-purple-500"
              />
              <div className="flex justify-between text-[10px] text-slate-400 font-semibold">
                <span>110 Normal</span>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                min="2"
                max="50"
                value={simParams?.insulin ?? 10}
                onChange={(e) => {
                  soundFX.play("slider");
                  setSimParams((prev) => ({
                    ...prev,
                    insulin: parseInt(e.target.value) || 10,
                  }));
                }}
                className="w-full h-2 rounded-lg appearance-none cursor-pointer accent-amber-400"
              />
