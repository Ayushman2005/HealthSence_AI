...
export default function Insights({
  ...
  return renderProtectedTab(
    <div className="space-y-6 animate-fade-in no-print">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4 glass-panel rounded-3xl p-6 border border-amber-500/20 shadow-sm">
        <div className="flex items-center gap-3">
          <label className="text-xs font-black text-slate-600 dark:text-slate-300 uppercase tracking-wider">Select Patient dataset:</label>
          <select 
            value={insightsUser}
      ...
      {uniquePatients.length === 0 ? (
        <div className="glass-panel rounded-3xl p-12 text-center flex flex-col items-center gap-4 border border-amber-500/20 shadow-xl">
          <div className="w-16 h-16 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-500 flex items-center justify-center animate-pulse">
            <Inbox className="w-8 h-8" />
          </div>
          <h3 className="font-black text-2xl text-slate-900 dark:text-white">No patient history found</h3>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
          ...
          <div className="xl:col-span-4 flex flex-col gap-6">
            <div className="glass-panel glass-panel-hover rounded-3xl p-6 flex-1 flex flex-col justify-center border border-amber-500/20">
              <h4 className="text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400 font-extrabold mb-1">Average Health Rating</h4>
              <div className="text-3xl font-black text-slate-900 dark:text-white">{insightsAggregates.avg}/100</div>
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">Average rating over patient timeline evaluations.</p>
            </div>
